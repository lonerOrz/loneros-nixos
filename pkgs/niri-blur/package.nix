...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "lonerOrz";
    repo = "niri";
    rev = "ef93d151b32028fe18d02a8b55069fc64d67f19a";
    hash = "sha256-YGU5mT5ezgEI6oUvf72bR24wbx2vAAiFCr/MbUZyGW0=";
  };

  cargoHash = "sha256-/jmV5mWYW3khDmyioSRj10IsfLtj5EYDIVSMK4KAc4A=";

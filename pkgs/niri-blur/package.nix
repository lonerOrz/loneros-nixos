...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "lonerOrz";
    repo = "niri";
    rev = "08d8c1b6fdd67cce273d3e5f4e6f391c592d7803";
    hash = "sha256-vOvaiN5hMbGa77qHWPPUV1gvfvjNHI9G+K3/xLiPmlk=";
  };

  cargoHash = "sha256-uKbCm7aW8uZNoJmiLrea8wH/ziwcu3l9AfXLY3g9x5Q=";
